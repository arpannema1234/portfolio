  ...
  return (
    <nav
      ...
      className={`w-full bg-neutral-900 text-white ${
        isVisible ? "sticky top-0 left-0 z-50 shadow-lg" : "static"
      }`}
    >
      <div className="w-full p-6 lg:px-8 xl:px-16">
        <div className="flex items-center justify-between gap-2 ">
          ...
          {/* mobile menu */}
          <div
            className={`absolute right-0 top-0 bg-neutral-900 text-neutral-50 p-4 min-h-screen w-2/3 sm:w-1/3 ${
