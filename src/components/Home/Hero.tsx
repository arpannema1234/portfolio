  ...
  return (
    <div id="hero" className="bg-neutral-900">
      <div className="max-w-7xl mx-auto w-full px-4 lg:px-8 xl:px-16">
        <div className="flex flex-col-reverse lg:flex-row justify-center py-3 lg:py-3 xl:py-3 gap-4 lg:gap-8 xl:gap-10 border-b border-black">
          <div className="lg:basis-3/5 py-10">
            ...
            <div className="text-4xl md:text-6xl text-neutral-50 font-bold dark:text-gray-900 mt-8">
              <h2 className="my-4 ">
                Hi, I&apos;m{" "}
                <span className="text-secondary-500">Arpan Nema</span>
              </h2>
              <p>
                <Typewriter
                  options={{
            ...
            <p className="my-8 text-lg text-neutral-400 max-w-xl md:max-w-2xl ">
              ...
              development. I specialize in technologies like React.js and
              Node.js and have a proven track record of creating impactful
              software solutions (primarily, web applications).
            </p>
